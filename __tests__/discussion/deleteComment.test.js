...
describe("/deleteDiscussionComment endpoint", () => {
  it.only("Should get a discussion Successfully", async (done) => {
    ...
    expect(deleteCommentRes.statusCode).toEqual(201);
    expect(updatedDiscussion.comments[0].comment).toEqual("Hello world");
